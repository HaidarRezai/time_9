...
import { FaPencil } from "react-icons/fa6";
  ...
  function Cart(){
    ...
    <div className="rounded-full">
          <div className=' bg-white  w-[20%] gap-10 border-t-35 border-viole-500 border-l-2 border-order-[#8C85FF]  border-r-2 border-indigo-500
          border-b-2 border-indigo-500 h-[71rem] rounded-4xl ml-220 -mt-285 p-4 pl-6 leading-7 pr-6'>
            <button className=" rounded-full h-[2rem] ml-65 bg-[#D5DFFF]  w-[22%] mb-10 mt-5 pb-5  font-bold">73%OFF</button>
             <p className='font-bold text-2xl'>Growth + AI </p>
             <p className='w-[80%] leading-6'>Made for high-traffic sites, scaling teams, and global growth</p>
             <p className='mt-3'>US$ <span className='font-bold text-4xl'>3.79</span>/mo</p>
             <button className='border w-[90%] rounded-lg h-[3rem] text-stone-50  bg-[#6743EA] font-bold mt-5 '>Choose Plan</button>
            ...
            <p className='leading-0 text-sm ml-5'>----------------------------</p>
              <a className='inline-block  text-green-800 font-bold leading-0 text-1xl  '><IoCheckmarkCircleOutline /></a>
            <span className='ml-2  text-stone-700 '>Up to 50 websites</span> <br/>
            ...
            <span className='ml-2  text-stone-700 -mt-10'>Vibe Code websites</span><br/>
             <a className='  text-green-800 font-bold leading-0 text-1xl inline-block '><IoCheckmarkCircleOutline /></a>
            <span className='ml-2  text-stone-700 -mt-10'>Up to 50 websites</span> <br/>
            <a className='  text-green-800 font-bold leading-0 text-1xl inline-block '></a>
             <a className='  text-green-800 font-bold leading-0 text-1xl inline-block '><IoCheckmarkCircleOutline /></a>
            <span className='ml-2  text-stone-700 -mt-10'><span className="font-bold">Basic</span> ecommerce</span> <br/>
            <a className='  text-green-800 font-bold leading-0 text-1xl inline-block '></a>
            ...
            <p className='leading-0 text-sm ml-5'>----------------------------</p>
                  <a className='inline-block  text-green-800 font-bold leading-0 text-1xl  '><IoCheckmarkCircleOutline /></a>
            <span className='ml-2  text-stone-700 '> <span className="font-bold">5</span> mailboxes for 1 year</span> <br/>
                   <a className='  text-green-800 font-bold leading-0 text-1xl inline-block '><HiMinusSmall/></a>
            <span className='ml-2 text-stone-700'>Email marketing up to <span className="font-bold">500</span> subscribers</span>
            <div>
        ...
        <span className='ml-2 text-stone-700'>50 free credits for AI tools</span> <br/>
