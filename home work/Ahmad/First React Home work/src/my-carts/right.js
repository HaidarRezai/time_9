...
function Right() {
    return (
        <div className="w-[26%] h-100  rounded-xl py-1 flex justify-center items-center flex-col ">
            ...
            <div className="w-[98%]  rounded-[18px] bg-[#fafbff] border-2 border-[#d5dfff] px-3 py-8 ">
                <div className="w-full flex justify-end ">
                    <p className="text-[12px] font-bold bg-[#d5dfff] w-20 rounded-full px-2 py-1 flex justify-center items-center">71% OFF</p>
                </div>
                <div>
                ...
                <div>
                    <span><span className="text-[15px]">US$</span><span className="text-[30px] font-bold">7.99</span><span className="text-[15px]">/mo</span></span>
                </div>
                <div className="mt-3">
                ...
                <div className="mt-7 space-y-2">
                    ...
                    <div className="flex items-center gap-2  mb-9">
                        <CiCircleCheck className="text-green-500" />Advanced ecommerce
                    </div>
                    ...
                    <div className="flex items-center gap-2 mb-9">
                         <CiCircleCheck className="text-green-500" />Email marketing up to 1000 subscribers
                    </div>
